...
public class CauHinhMauHopDongAsserts {
     ...
     */
    public static void assertCauHinhMauHopDongAllPropertiesEquals(CauHinhMauHopDong expected, CauHinhMauHopDong actual) {
        assertCauHinhMauHopDongAutoGeneratedPropertiesEquals(expected, actual);
        assertCauHinhMauHopDongAllUpdatablePropertiesEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertCauHinhMauHopDongAllUpdatablePropertiesEquals(CauHinhMauHopDong expected, CauHinhMauHopDong actual) {
        assertCauHinhMauHopDongUpdatableFieldsEquals(expected, actual);
        assertCauHinhMauHopDongUpdatableRelationshipsEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertCauHinhMauHopDongAutoGeneratedPropertiesEquals(CauHinhMauHopDong expected, CauHinhMauHopDong actual) {
        assertThat(expected)
            .as("Verify CauHinhMauHopDong auto generated properties")
     ...
     * @param actual the actual entity
     */
    public static void assertCauHinhMauHopDongUpdatableFieldsEquals(CauHinhMauHopDong expected, CauHinhMauHopDong actual) {
        assertThat(expected)
            .as("Verify CauHinhMauHopDong relevant properties")
     ...
     * @param actual the actual entity
     */
    public static void assertCauHinhMauHopDongUpdatableRelationshipsEquals(CauHinhMauHopDong expected, CauHinhMauHopDong actual) {}
}
