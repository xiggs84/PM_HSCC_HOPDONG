...
public class CauHinhMauHopDongTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));

    public static CauHinhMauHopDong getCauHinhMauHopDongSample1() {
        return new CauHinhMauHopDong()
            .id(1L)
            .idLoaiHd(1L)
            .dienGiai("dienGiai1")
            .idVaiTro1(1L)
    ...
    public static CauHinhMauHopDong getCauHinhMauHopDongSample2() {
        return new CauHinhMauHopDong()
            .id(2L)
            .idLoaiHd(2L)
            .dienGiai("dienGiai2")
    ...
    public static CauHinhMauHopDong getCauHinhMauHopDongRandomSampleGenerator() {
        return new CauHinhMauHopDong()
